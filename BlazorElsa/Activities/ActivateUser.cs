...
namespace BlazorElsa.Activities
{
    ...
    public class ActivateUser : Activity
    {
        ...
        protected override async Task<ActivityExecutionResult> OnExecuteAsync(WorkflowExecutionContext context, CancellationToken cancellationToken)
        {
            ...
            var user = await store.AsQueryable().FirstOrDefaultAsync(x => x.Id == userId, cancellationToken);
            ...
            await store.ReplaceOneAsync(x => x.Id == userId, user, cancellationToken: cancellationToken);
